...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Marks of TestID <?= $tid ?></title>
    ...
    <body>
        ...
        <div id="main">
            ...
            <div id="panel" style="color: darkslategrays;">
                <div>
                    <i style="color: blue; padding-left: 20px"> The following are the marks of this test (TestId <?= $tid ?> ) scored by you in previous attempts  ! </i> 
                </div>
                <br>
                <table  class="table">
                    <tr>
                    ...
                    <tr>
                        ...
                        foreach ($out as $row) {
                            ...
                            echo "<td>$row->test_completed</td></tr>";
                        }
                        ?>
                    </tr>
