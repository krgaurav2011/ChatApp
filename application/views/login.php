<html>
    ...
    <body>
        ...
        <form class="frm frm-login" id="login-form" action="<?= base_url('login/dologin_submit'); ?>" method="post" name="login">
            ...
            <table >
                ...
                <tr>
                    <td class="forgot-password" colspan="2"><a href="<?= base_url('register/doregister'); ?>"> New Users Register Here ! </a></td>
                </tr>
            </table>
